"""n_uber_24118 URL Configuration
...
admin.site.site_header = "n_Uber"
admin.site.site_title = "n_Uber Admin Portal"
admin.site.index_title = "n_Uber Admin"

# swagger
api_info = openapi.Info(
    title="n_Uber API",
    default_version="v1",
    description="API documentation for n_Uber App",
)
